      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-white">
        ...
        <div className="w-full max-w-md mx-auto flex flex-col items-start px-8 pt-8">
          <div className="flex items-center mb-8">
            ...
            <span className="text-2xl font-bold text-gray-800">InsideBox</span>
          </div>
          <span className="text-gray-500 mb-1">Start your journey</span>
          <h2 className="text-2xl font-bold mb-6">Sign Up to InsideBox</h2>
        </div>
        {/* Formulario */}
        <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto px-8 space-y-4">
          ...
          {/* Botón principal */}
          <button type="submit" className="w-full bg-blue-600 text-white font-semibold py-3 rounded-md hover:bg-blue-700 transition-colors duration-200">Sign Up</button>
          {/* Separador */}
          ...
          <div className="flex justify-center gap-4 mt-2">
            <button type="button" className="flex items-center justify-center w-12 h-12 rounded-md border border-gray-200 bg-white hover:bg-gray-100">
